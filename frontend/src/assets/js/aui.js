...
(function( window, undefined ) {
    ...
    auiDialog.prototype = {
        ...
        close: function(){
            ...
            var self_a = document.querySelector(".aui-dialog");
            if(self_a) {
                self_a.classList.remove("aui-dialog-in");
                self_a.classList.add("aui-dialog-out");
            }
            ...
            if (document.querySelector(".aui-dialog:not(.aui-dialog-out)")) {
                ...
                if (self_a) {
                    self_a.addEventListener("webkitTransitionEnd", function () {
                        self.remove();
                    });
                    self_a.addEventListener("transitionend", function () {
                        self.remove();
                    })
                }
            }
